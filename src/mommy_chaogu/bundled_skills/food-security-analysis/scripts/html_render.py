...
def render_hero(d: dict) -> str:
    ...
    <h1>粮食安全/危机 主题分析 · <em>{data_label} 复盘</em></h1>
    <p class="hero-sub">35 只篮子 · 4 变量触发 · Top 5 推荐 + 均线技术面 · 数据可审计, 推荐可次日验证。</p>
    <div class="hero-stats">
      ...
      <div class="stat">
        ...
        <div class="stat-value">35<span class="unit">只</span></div>
        <div class="stat-note">4 chain × 14 sub</div>
      </div>
      <div class="stat">
        <div class="stat-label">资金流</div>
        <div class="stat-value">{coverage}<span class="unit">/35</span></div>
        <div class="stat-note">{coverage*100//35}% 覆盖</div>
      </div>
      <div class="stat">
      ...
      <div class="stat">
        ...
        <div class="stat-value">4<span class="unit">/4</span></div>
        <div class="stat-note">动能强</div>
      </div>
    </div>'''
...
def render_triggers() -> str:
    ...
    <div class="trigger-grid">
      <div class="trigger-card met">
        <div class="trigger-icon">{ICONS["trending"]}</div>
        <div class="trigger-label">① FAO 谷物环比</div>
        <div class="trigger-value">+3.4%</div>
        <div class="trigger-thresh">阈值: ≥ +2%</div>
        <div class="trigger-status"><span class="dot"></span>已持续 4 个月上行</div>
      </div>
      <div class="trigger-card met">
        <div class="trigger-icon">{ICONS["down"]}</div>
        <div class="trigger-label">② 黑海海运同比</div>
        <div class="trigger-value">-40%</div>
        <div class="trigger-thresh">阈值: ≤ -30%</div>
        <div class="trigger-status"><span class="dot"></span>俄袭击敖德萨港口</div>
      </div>
      <div class="trigger-card met">
        <div class="trigger-icon">{ICONS["globe"]}</div>
        <div class="trigger-label">③ 厄尔尼诺强度</div>
        <div class="trigger-value">强</div>
        <div class="trigger-thresh">ONI ≥ 1.5 (强)</div>
        <div class="trigger-status"><span class="dot"></span>70 年最强</div>
      </div>
      <div class="trigger-card met">
        <div class="trigger-icon">{ICONS["chart"]}</div>
        <div class="trigger-label">④ 399365 PE 分位</div>
        <div class="trigger-value">36.5%</div>
        <div class="trigger-thresh">阈值: ≤ 40%</div>
        <div class="trigger-status"><span class="dot"></span>估值历史低位</div>
      </div>
    </div>
    <div class="verdict">
      <div class="verdict-badge">4 / 4</div>
      <div class="verdict-text"><strong>主题动能强</strong> · 板块整体可超配 · 任一变量反转即降至 ≤ 2/4 触发需减仓</div>
    </div>'''
...
def render_crisis_drivers() -> str:
    return f'''
    <div class="crisis-grid">
      <div class="crisis-card">
        <div class="crisis-head">
          <div class="crisis-icon">{ICONS["anchor"]}</div>
          <div class="crisis-name">黑海出口扰动</div>
        </div>
        <div class="crisis-stat">-40%</div>
        <div class="crisis-desc">7 月底黑海出货量同比 -40%, 俄罗斯袭击敖德萨港口。USDA 估 2026/27 美国小麦 -26%, 加拿大 -15%, 澳洲 -12%。</div>
        <span class="crisis-tag">供给冲击 · 短期</span>
      </div>
      <div class="crisis-card">
        <div class="crisis-head">
          <div class="crisis-icon">{ICONS["leaf"]}</div>
          <div class="crisis-name">厄尔尼诺 70 年最强</div>
        </div>
        <div class="crisis-stat">强</div>
        <div class="crisis-desc">印度季风迟到, 印度洋偶极子 (IOD) 转正。澳洲冬麦预估减产 21%。WFP 警告 5000 万人可能陷入急性饥饿。</div>
        <span class="crisis-tag">气候冲击 · 中期</span>
      </div>
      <div class="crisis-card">
        <div class="crisis-head">
          <div class="crisis-icon">{ICONS["drop"]}</div>
          <div class="crisis-name">中东/霍尔木兹</div>
        </div>
        <div class="crisis-stat">+144%</div>
        <div class="crisis-desc">伊朗/中东战争 → 霍尔木兹海峡封锁 → 全球约 1/3 化肥走此通道。藏格碳酸锂价格同比 +144%。粮价 → 农化大周期滞后 1-2 年。</div>
        <span class="crisis-tag">成本传导 · 中长期</span>
      </div>
      <div class="crisis-card">
        <div class="crisis-head">
          <div class="crisis-icon">{ICONS["grid"]}</div>
          <div class="crisis-name">北半球减产</div>
        </div>
        <div class="crisis-stat">+25%</div>
        <div class="crisis-desc">小麦自 2026/1 已上涨 25%, 创 2 年新高。FAO 7 月谷物 +3.4% / 小麦 +5.8% / 玉米 +3.6% / 糖 +5.6%。</div>
        <span class="crisis-tag">供需失衡 · 持续</span>
      </div>
    </div>'''
...
def render_checklist(d: dict) -> str:
    ...
    items.append('<div class="check-item"><div class="check-num">6</div><div>农业板块是否延续强势, <strong>国证 399365</strong> 是否突破, 量能是否放大</div></div>')
    items.append('<div class="check-item"><div class="check-num">7</div><div><strong>粮食 ETF 鹏华 159698</strong> 净流入是否持续, 主题资金面</div></div>')
    items.append('<div class="check-item"><div class="check-num">8</div><div>重跑 <code>mommy food-security list</code> 确认 35 只都在, <code>flows pull</code> 看 9 只限流能不能补上</div></div>')
    items.append('<div class="check-item"><div class="check-num">9</div><div>重拉 5 只 K线对照 MA5/10/20/60 数字, 与本报告 data.json 对比</div></div>')
    items.append('<div class="check-item"><div class="check-num">10</div><div>memory topic 锚点是否清晰可对照</div></div>')
    items.append('<div class="check-item"><div class="check-num">11</div><div>黑海局势是否有新进展, FAO 8 月数据是否公布 (一般月初)</div></div>')
    items.append('<div class="check-item"><div class="check-num">12</div><div>厄尔尼诺强度更新 (NOAA 周报), 4 变量触发状态变化</div></div>')
...
def render_topbar(d: dict) -> str:
    ...
    data_label = "close" if is_close else "mid-day"
    sections = [
        ("hero", "封面"), ("triggers", "4 变量"), ("basket", "35 只篮子"),
  ...
  <div class="topbar-inner">
    <div class="topbar-brand">粮食安全 · {today_bj} {data_label}</div>
...
def render_charts_section(d: dict) -> str:
    ...
    flow_ts = d.get("top5_flow_ts", {})  # { code: [ {time, main_net, super_large, large, medium, small}, ... ] }
    ...
    <div class="chart-grid">
      ...
      <div class="chart-card">
        ...
        <div class="chart-sub">FAO 食品价格指数 / 厄尔尼诺强度 / FPI PE 10 年分位 / 黑海谷物同比</div>
...
def render_html(d: dict, session_id: str = "n/a",
    ...
    <section id="section-triggers">
      <div class="section-head"><div class="section-num">01</div><div><h2>4 变量触发 · 主题动能监控</h2><p>粮食安全主题需 4 变量共振, 当前全部触发, 板块整体可超配。任一变量反转即降级。</p></div></div>
      {render_triggers()}
    </section>''')
    sections.append(f'''
    <section id="section-basket">
      <div class="section-head"><div class="section-num">02</div><div><h2>主题篮子 · 35 只 · 4 chain × 14 subcategory</h2><p>仿 semicon 模板自建, 上游 (农资 19) 占比 54% — 主题最纯粹的入口集中在种子/化肥/农药。</p></div></div>
      {render_chain_basket()}
    </section>''')
    sections.append(f'''
    <section id="section-flow">
      <div class="section-head"><div class="section-num">03</div><div><h2>主力资金流 · {today_bj} 收盘</h2><p>种业 (神农+农发) 合计 +3.72亿, 远超化肥板块。盐湖被抛 -1.36亿 与同板块藏格 +0.86亿 形成分化。鼠标悬停查看每只资金流明细。</p></div></div>
      {render_money_flow(d)}
    </section>''')
    sections.append(f'''
    <section id="section-top5">
      <div class="section-head"><div class="section-num">04</div><div><h2>Top 5 推荐 · 高弹性 + 基本面 + 技术面</h2><p>种业占 3 席 (权重 60%), 化肥 2 席 (权重 40%)。神农短线超买需等回踩, 藏格回踩中反而是机会。点击卡片可跳到对应验证清单条目。</p></div></div>
      {render_top5_cards(d)}
    </section>''')
    sections.append(f'''
    <section id="section-ma">
      <div class="section-head"><div class="section-num">05</div><div><h2>均线技术面对比 · 60 日 K线</h2><p>仅登海/隆平/农发呈完美多头排列, 藏格/神农震荡中。神农 MA20 偏离 +13.4% 严重超买, 藏格 -1.8% 等启动。</p></div></div>
      {render_ma_table(d)}
    </section>''')
    sections.append(f'''
    ...
    <section id="section-crisis">
      <div class="section-head"><div class="section-num">07</div><div><h2>全球粮食危机 · 4 大驱动</h2><p>FAO 食品价格指数 7 月 131.1, 自 2023 年 1 月以来最高 (3.5 年新高)。四大驱动同向共振。</p></div></div>
      {render_crisis_drivers()}
    </section>''')
    sections.append(f'''
    <section id="section-snapshot">
      <div class="section-head"><div class="section-num">08</div><div><h2>A 股 {today_bj} 午间/收盘快照</h2><p>三大指数集体上涨, 农业板块涨停潮直接撞上粮食安全主题。</p></div></div>
    ...
    body = "\n".join(sections)
    title = f"粮食安全/危机 · {today_bj} {data_label} · 主题分析"
...
(function() {{
  ...
  script.onload = function() {{
    ...
    /* 4-variable history (mixed chart) */
    ...
    if (varsCanvas && payload.var_history) {{
      ...
      new Chart(varsCanvas, {{
        ...
        data: {{
          labels: h.months,
          datasets: [
            {{ label: 'FAO 食品价格指数', data: h.fao_index, backgroundColor: '#2f6f5e', yAxisID: 'y' }},
            {{ label: '厄尔尼诺强度', data: h.el_nino_strength, backgroundColor: '#c97b3f', yAxisID: 'y' }},
            {{ label: 'FPI PE 10 年分位 (%)', data: h.fpi_pe_pctile, backgroundColor: '#5a7da5', yAxisID: 'y' }},
            {{ label: '黑海谷物同比 (%)', data: h.ukraine_grain_yoy, backgroundColor: '#b06367', yAxisID: 'y2' }},
          ],
        }},
        options: {{
          responsive: true, maintainAspectRatio: false,
