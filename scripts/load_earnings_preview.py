...
DATA: list[tuple[str, str, str, str, float, float, str, str, str]] = [
    # ====== 半导体-存储 ======
    ("603986", "兆易创新", "半导体", "存储", 1070.0, 1370.0, "+1070%~+1370%",
     "AI/涨价", "业绩大增长动力强劲，AI 算力受益"),
    ("300223", "北京君正", "半导体", "存储", 440.0, 520.0, "+440%~+520%",
     "AI/涨价", "业绩大增长动力强劲，AI 算力受益"),

    # ====== 半导体-IC设计 ======
    ("603501", "韦尔股份", "半导体", "IC设计", 30.0, 40.0, "+30%~+40%",
     "AI", "受益高端 CIS 需求"),
    ("688052", "纳芯微", "半导体", "IC设计", 50.0, 60.0, "+50%~+60%",
     "自主可控", "持续受益汽车业务趋势"),
    ("688213", "思特威", "半导体", "IC设计", 20.0, 25.0, "+20%~+25%",
     "AI/智能驾驶", "高端 CIS 国产替代"),
    ("301536", "星宸科技", "半导体", "IC设计", 336.0, 627.0, "+336%~+627%",
     "AIoT", "端侧 AI 需求强劲"),
    ("603893", "瑞芯微", "半导体", "IC设计", 20.0, 40.0, "+20%~+40%",
     "AIoT", "AIoT 景气度延续"),
    ("688403", "汇成股份", "半导体", "IC设计", 10.0, 15.0, "+10%~+15%",
     "自主可控", "DDIC 稳健增长，2.5D 封装储备"),

    # ====== 半导体-设备 ======
    ("002371", "北方华创", "半导体", "设备", 30.0, 50.0, "+30%~+50%",
     "自主可控", "国产半导体设备平台龙头，存储/逻辑订单高速增长"),
    ("688012", "中微公司", "半导体", "设备", 28.0, 40.0, "+28%~+40%",
     "自主可控", "半导体设备平台龙头，存储订单高速增长"),
    ("688120", "华海清科", "半导体", "设备", 20.0, 40.0, "+20%~+40%",
     "自主可控", "国产替代，存储订单高速增长"),
    ("688037", "芯源微", "半导体", "设备", 20.0, 40.0, "+20%~+40%",
     "自主可控", "受益存储/逻辑/先进封装"),
    ("688383", "新益昌", "半导体", "LED设备", 430.0, 671.0, "+430%~+671%",
     "业绩弹性", "LED 行业景气平稳向上，高端设备加速迭代"),

    # ====== 半导体-材料 ======
    ("688519", "南亚新材", "半导体", "CCL材料", 354.0, 505.0, "+354%~+505%",
     "涨价", "CCL 涨价传导落地，高稼动率"),
    ("688072", "富创精密", "半导体", "零部件", 188.0, 217.0, "+188%~+217%",
     "自主可控", "半导体零部件国产替代"),
    ("002617", "露笑科技", "半导体", "材料", 336.0, 627.0, "+336%~+627%",
     "涨价", "SiC 衬底业务弹性"),
    ("603290", "斯达半导", "半导体", "功率", -51.0, -2.0, "-51%~-2%",
     "涨价/份额", "受 SiC 衬底价格上涨影响，行业市占率持续提升"),

    # ====== 半导体-封测 ======
    ("002156", "通富微电", "半导体", "封测", 15.0, 20.0, "+15%~+20%",
     "AI", "先进封装国内领先，AMD/存储需求增长"),
    ("600584", "长电科技", "半导体", "封测", 10.0, 15.0, "+10%~+15%",
     "AI/涨价", "先进封装国内龙头，电源管理/存储需求增长"),

    # ====== AI 算力 ======
    ("688256", "寒武纪", "AI算力", "训练芯片", 126.0, 183.0, "+126%~+183%",
     "AI", "算力高增预期强"),
    ("688041", "海光信息", "AI算力", "DCU", 83.0, 96.0, "+83%~+96%",
     "AI", "算力高增预期强"),

    # ====== PCB/CCL ======
    ("002463", "沪电股份", "PCB", "AI服务器PCB", 52.0, 74.0, "+52%~+74%",
     "AI", "AI PCB 需求景气高，产能持续释放"),
    ("300476", "胜宏科技", "PCB", "AI服务器PCB", 15.0, 23.0, "+15%~+23%",
     "AI", "AI PCB 需求景气高，产能持续释放"),
    ("002916", "深南电路", "PCB", "AI服务器PCB", 15.0, 50.0, "+15%~+50%",
     "AI", "AI PCB 需求景气高，产能持续释放"),
    ("001389", "广合科技", "PCB", "AI服务器PCB", 99.0, 119.0, "+99%~+119%",
     "AI", "加速向下游涨价传导成本，比利时新设备投入"),
    ("603920", "世运电路", "PCB", "汽车PCB", -51.0, -2.0, "-51%~-2%",
     "涨价", "加速向下游涨价传导成本，比利时新设备投入"),

    # ====== 面板/LED ======
    ("000100", "TCL科技", "面板", "LCD", 61.0, 84.0, "+61%~+84%",
     "涨价", "LCD 涨价趋势高位，整体业绩有望高增"),
    ("000725", "京东方A", "面板", "LCD/OLED", -2.0, 10.0, "-2%~+10%",
     "涨价", "LCD 涨价趋势高位，OLED 短期承压"),
    ("002876", "三孚新科", "面板", "材料", 261.0, 502.0, "+261%~+502%",
     "涨价", "面板产业链景气度高"),
    ("002745", "木林森", "LED", "封装", 824.0, 1286.0, "+824%~+1286%",
     "业绩弹性", "LED 行业景气平稳向上，业绩结构改善"),
    ("300708", "聚灿光电", "LED", "芯片", -28.0, -8.0, "-28%~-8%",
     "业绩弹性", "LED 行业景气平稳向上，业绩结构改善"),

    # ====== 传感器 ======
    ("603662", "柯力传感", "传感器", "六维力", 188.0, 217.0, "+188%~+217%",
     "机器人/工业", "持续受益于人形机器人/工业传感器需求"),
    ("688007", "优利德", "传感器", "测试仪器", 20.0, 36.0, "+20%~+36%",
     "业绩弹性", "业务结构优化，业绩结构改善"),

    # ====== 机器人 ======
    ("002472", "双环传动", "机器人", "丝杠/外骨骼", 30.0, 40.0, "+30%~+40%",
     "机器人/清洁能源", "北美客户多领域放量，丝杠/外骨骼协同放量"),

    # ====== 消费电子 ======
    ("002600", "领益智造", "消费电子", "精密结构件", 0.0, 10.0, "+0%~+10%",
     "AI/客户放量", "北美大客户多领域放量，AI 服务器/折叠机/PC 起量"),
    ("002241", "歌尔股份", "消费电子", "声学/光学", 0.0, 10.0, "0%~+10%",
     "AI", "北美 AI 眼镜业务起量，AR 新品"),
    ("002273", "水晶光电", "消费电子", "光学", 10.0, 20.0, "+10%~+20%",
     "客户放量", "北美大客户终端放量"),
    ("300433", "蓝思科技", "消费电子", "玻璃/金属", -30.0, -20.0, "-30%~-20%",
     "客户转型", "客户结构转型期，业绩承压"),
    ("603296", "华勤技术", "消费电子", "ODM", 20.0, 30.0, "+20%~+30%",
     "AI/客户放量", "AI 服务器/折叠机/PC 多领域放量"),
    ("300115", "协创数据", "消费电子", "存储模组", 10.0, 20.0, "+10%~+20%",
     "涨价", "存储涨价向下游传导"),
    ("300613", "雷神科技", "消费电子", "电脑/外设", 133.0, 180.0, "+133%~+180%",
     "AI", "AI PC 换机周期"),
]
        ...
        try:
            ...
            cursor.execute(
                ...
                (
                    ...
                    REPORT_DATE,
                    watchlist_flag,
                    code, REPORT_PERIOD, REPORT_SOURCE,
                ),
            )
            updated += 1
...
def print_summary(conn: sqlite3.Connection) -> None:
    ...
    # 总数
    cursor.execute("SELECT COUNT(*) FROM earnings_preview WHERE report_period = ?", (REPORT_PERIOD,))
    total = cursor.fetchone()[0]
    print(f"\n总计: {total} 家公司")

    # 板块汇总
    print("\n板块汇总（按平均增速排序）:")
    print(f"{'板块':　<12} {'家数':>4} {'平均增速':>10} {'最高':>10} {'最低':>10} {'+200%':>5} {'+50~+200':>8} {'下滑':>4}")
    print("-" * 70)
    cursor.execute("SELECT * FROM v_sector_summary")
    for row in cursor.fetchall():
        sector, n, avg, mx, mn, exp, high, dec = row
        print(f"{sector:　<12} {n:>4} {avg:>+9.1f}% {mx:>+9.1f}% {mn:>+9.1f}% {exp:>5} {high:>8} {dec:>4}")
