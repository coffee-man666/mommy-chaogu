...
class TestAgentServiceWithMemory:
    ...
    @patch("openai.OpenAI")
    def test_chat_persists_to_memory(self, _mock_openai: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("openai.OpenAI")
    def test_chat_loads_memory_as_context(self, _mock_openai: MagicMock, tmp_path: Path) -> None:
